...
a(game.includes('const VERSION="2.7.0"'), "Deterministic clock debe estar etiquetado como 2.7.0");
...
a(schema.includes("create or replace function public.cronogol_server_time_ms()"), "SQL v2.7.0 debe crear RPC de hora servidor");
a(schema.includes("grant execute on function public.cronogol_server_time_ms() to anon"), "SQL v2.7.0 debe conceder ejecución a anon");
