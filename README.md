# CronoGol v2.5.5 — Menu Rules/Rival Cleanup
...
## v2.5.5 — Menu Rules/Rival Cleanup
...
## v2.5.5 — Rules First & Host Mode Sync
...
## v2.5.5 — Rules Selector & Online Sanctions Fix
...
## v2.5.5 — Online Throws & Score Sync
...
## v2.5.5 — Online Start Role & Names Fix
...
## v2.5.5 — Ko-fi URL & Auto Online Room
...
- Cache busting actualizado a `game.js?v=2.5.5` y `style.css?v=2.5.5`.
