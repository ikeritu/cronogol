...
## v2.4.6 — Menu Rules/Rival Cleanup
...
## v2.4.6 — Rules First & Host Mode Sync
...
## v2.4.6 — Rules Selector & Online Sanctions Fix
...
## v2.4.6 — Online Throws & Score Sync
...
## v2.4.6 — Online Start Role & Names Fix
...
## v2.4.6 — Ko-fi URL & Auto Online Room
...
- Cache busting actualizado a `game.js?v=2.4.6` y `style.css?v=2.4.6`.
