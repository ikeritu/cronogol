# CronoGol v2.5.7 — Menu Rules/Rival Cleanup
...
## v2.5.7 — Menu Rules/Rival Cleanup
...
## v2.5.7 — Rules First & Host Mode Sync
...
## v2.5.7 — Rules Selector & Online Sanctions Fix
...
## v2.5.7 — Online Throws & Score Sync
...
## v2.5.7 — Online Start Role & Names Fix
...
## v2.5.7 — Ko-fi URL & Auto Online Room
...
- Cache busting actualizado a `game.js?v=2.5.7` y `style.css?v=2.5.7`.
